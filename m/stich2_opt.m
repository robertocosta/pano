...
global glob
    ...
    if (trX<0)
        % add zeros at the beginning of im1
        im1 = [zeros(size(im1,1),ceil(abs(trX))),im1];  
    else
        % add zeros at the end of im1
        im1 = [im1,zeros(size(im1,1),ceil(abs(trX)))];  
    end
